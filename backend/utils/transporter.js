...
if (!process.env.SMTP_EMAIL_USER || !process.env.SMTP_EMAIL_PASS) {
  console.error(
    "❌ EMAIL SERVICE ERROR: SMTP_EMAIL_USER and SMTP_EMAIL_PASS environment variables must be set.",
  );
  throw new Error(
    "SMTP credentials missing. Set SMTP_EMAIL_USER and SMTP_EMAIL_PASS in your environment.",
  );
}
