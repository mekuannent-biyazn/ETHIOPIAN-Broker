    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-yellow-700 space-y-1">
          <li>• {t("client.firstLastNameRequired")}</li>
          <li>• {t("client.phoneEthiopianFormat")}</li>
          <li>• {t("client.passwordMinimumCharacters")}</li>
          <li>• {t("client.emailCannotChangeSecurity")}</li>
          <li>• {t("client.otherFieldsOptional")}</li>
        </ul>
      </div>
    </div>
  );
