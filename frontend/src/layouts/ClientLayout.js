...
const ClientLayout = () => {
  ...
  const navigation = [
    ...
    {
      name: t("layout.browseProperties"),
      href: "/properties",
      icon: (
        <svg
          className="w-5 h-5"
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Desktop Sidebar - Telegram Style (Purple for Client) */}
      <div
        className={`hidden md:flex transition-all duration-300 ${
          sidebarCollapsed ? "w-20" : "w-64"
        }`}
      >
        <div className="flex flex-col w-full bg-gradient-to-b from-purple-900 via-purple-800 to-purple-900 text-white">
          {/* Brand/Logo Section */}
          <div className="p-4 border-b border-purple-700">
            <div className="flex items-center justify-between">
              {sidebarCollapsed ? (
                <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center mx-auto">
                  <span className="text-purple-900 font-bold text-lg">M4S</span>
                </div>
              ) : (
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-purple-200 text-xs">Client Portal</p>
                  </div>
                </div>
              )}
              <button
                ...
                <button
                  ...
                  className={`w-full flex items-center px-3 py-3 rounded-lg transition-all duration-200 ${
                    isActive(item.href)
                      ...
                      : "text-purple-100 hover:bg-purple-700 hover:bg-opacity-50"
                  }`}
                >
            ...
            {!sidebarCollapsed && (
              <div className="mt-6 px-3">
                <button
                  ...
                  className="w-full flex items-center justify-center px-3 py-2 bg-purple-700 hover:bg-purple-600 rounded-lg transition-colors"
                >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white shadow-sm border-b">
          <div className="flex items-center justify-between h-16 px-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={toggleLanguage}
                className="md:hidden text-sm bg-purple-600 text-white px-3 py-1 rounded hover:bg-purple-700 transition-colors"
              >
        ...
        >
          ...
          />
          <div className="relative flex flex-col w-64 h-full bg-gradient-to-b from-purple-900 to-purple-800 text-white">
