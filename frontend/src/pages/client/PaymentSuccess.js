...
//         {/* Green Success Header - Only Visible Part */}
//         <div className="bg-green-600 text-white py-12 text-center rounded-lg shadow-lg">
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          {/* Header - Conditional based on payment status */}
          <div
            className={`${
